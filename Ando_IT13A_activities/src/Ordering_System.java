...
public class Ordering_System {
    ...
    static final String USERS_FILE = "C:\\Users\\acer\\Documents\\users.txt";
    static final String HISTORY_FILE = "C:\\Users\\acer\\Documents\\history.txt";
    static final int SHIFT = 3;

    static String[] items = {"Pizza", "Burger", "Fries"};
    static int[] prices = {120, 80, 50};
